...
public class US1PendingGoalTest {
    ...
    {
        Comparable goal1 = new PendingGoal(1, "Goal 1", true, 1, Context.HOME, false);
        Comparable goal2 = new PendingGoal(1, "Goal 1", true, 1, Context.HOME, false);
        Comparable goal3 = new PendingGoal(2, "Goal 2", false, 2, Context.WORK, true);// Reflexive
